...
const isCwdInScope = isPackageExists('@skiyee/eslint-config')
 ...
 * @example
 * ```ts
 * import { renameRules } from '@skiyee/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@skiyee/eslint-config'
